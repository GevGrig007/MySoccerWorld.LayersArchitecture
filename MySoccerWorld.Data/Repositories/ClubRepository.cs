...
namespace MySoccerWorld.Data.Repositories
{
    public class ClubRepository : IClubRepository
    {
        ...
        public Task<Club> DetailsAsync(int id) =>
        ...
        public Task<List<Club>> RatingAsync() =>
        ...
        public List<Player> Players(int id)
        {
            ...
            var clubPlayers =  players.Where(p => p.PlayerTeams.Last().TeamId == id);
        ...
        {
            if (club.Id == 0)   await _context.Teams.AddAsync(club);
            else  _context.Entry(club).State = EntityState.Modified;
        }
